    ...
    public partial class @new : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Zvirata", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ZvireID = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderItems_Zvirata_ZvireID",
                        column: x => x.ZvireID,
                        principalTable: "Zvirata",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "nejlepší zviratko na světě", "/img/zviratka/krecek.png", "Křeček", 2.0 },
                    { 2, "nejlepší chleba v galaxii", "/img/zviratka/lenochod.png", "Lenochod", 50.0 },
                    { 3, "nejlepší bageta ve vesmíru", "/img/zviratka/myval.png", "Mýval", 40.0 },
                    { 4, "nejlepší bageta ve vesmíru", "/img/zviratka/pejsek.png", "Pes", 40.0 }
                });
